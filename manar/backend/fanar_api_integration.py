        ...
        return '''
        {
            "recommendations": [
                ...
                },
                {
                    "name": "Souq Waqif",
                    "type": "attraction",
                    "description": "Traditional marketplace with authentic Qatari architecture",
                    "location": "Old Doha",
                    "price_range": "Free entry",
                    "rating": 4.7,
                    "estimated_duration": "2-4 hours",
                    "why_recommended": "Essential for experiencing local culture and shopping",
                    "booking_available": false,
                    "best_time_to_visit": "Evening for best atmosphere"
                },
                {
                    ...
                    "why_recommended": "Excellent traditional food with waterfront ambiance",
...
class ManaraAI:
    ...
    """
    def __init__(self, fanar_api_key: str, vector_db_path: str = "./chroma_db"):
        print("🚀 Initializing ManaraAI system...")
        self.rag_system = QatarRAGSystem(fanar_api_key, vector_db_path)
        print("✅ ManaraAI system ready!")
